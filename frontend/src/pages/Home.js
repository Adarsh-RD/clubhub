      ...
      <main className="main-content">
        ...
        <footer style={{ marginTop: '50px', padding: '30px 0 100px 0', borderTop: '1px solid rgba(255,255,255,0.05)', textAlign: 'center', color: '#64748b', fontSize: '0.85rem' }}>
          <div style={{ display: 'flex', justifyContent: 'center', flexWrap: 'wrap', gap: '15px', marginBottom: '20px' }}>
            <a href="#" onClick={(e) => { e.preventDefault(); alert('About page under construction!'); }} style={{ color: '#94a3b8', textDecoration: 'none', transition: 'color 0.2s' }} onMouseOver={(e)=>e.currentTarget.style.color='#f8fafc'} onMouseOut={(e)=>e.currentTarget.style.color='#94a3b8'}>About</a>
            <a href="#" onClick={(e) => { e.preventDefault(); alert('Accessibility page under construction!'); }} style={{ color: '#94a3b8', textDecoration: 'none', transition: 'color 0.2s' }} onMouseOver={(e)=>e.currentTarget.style.color='#f8fafc'} onMouseOut={(e)=>e.currentTarget.style.color='#94a3b8'}>Accessibility</a>
